...
class Fend_Http_Socket
{
    protected $_timeout =30;    //连接超时时间
    protected $_loop    =0;     //设置301重定向深度，0为关闭301
    protected $_ip      =null;  //设置主机IP地址，不设置则会走DNS解析
    protected $_size    =10240; //下载的数据大小(单位KB)
    protected $_method  =null;  //当前请求类型
    protected $_referer =null;  //来访URL
    protected $_post    =null;  //post信息
    protected $_debug   =0;     //调试信息
    protected $_agent   ='Mozilla/5.0 (Macintosh; Intel Mac OS X 10_10_2) AppleWebKit/537.36 Chrome/37.0.2062.94 Fend/1.0';//访问头信息
