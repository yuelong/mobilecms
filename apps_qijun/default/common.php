...
class Common extends Router
{
    ...
    public function Init()
    {
        ...
        self::regVar(Conf_Qijun::$header_menu, 'tmy_header_menu');
        self::regVar(Conf_Qijun::$header_menu_more, 'tmy_header_menu_more');
        self::regVar(Conf_Qijun::$footer_menu, 'tmy_footer_menu');
        self::regVar($this->lib, 'tmy_lib');
        self::regVar($this->act, 'tmy_act');
        $menu = array_merge(Conf_Qijun::$header_menu, Conf_Qijun::$header_menu_more, Conf_Qijun::$footer_menu);
