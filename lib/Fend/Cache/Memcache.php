...
class Fend_Cache_Memcache extends Fend
{
    ...
    public function __construct()
    {
        ...
        @$this->mc->connect(
                        isset($this->mccfg['host']) ? $this->mccfg['host'] : '127.0.0.1', isset($this->mccfg['port']) ? $this->mccfg['port'] : '11211'
    ...
    private function setLifeTime($t)
    {
        ...
        if ($t > 2592000)
            self::showMsg('Memcached Backend has a Limit of 30 days (2592000 seconds) for the LifeTime');
        return $t;
    }
